...
namespace xchwallet.Migrations
{
    ...
    [Migration("20190728212650_ChainTxNetworkStatus")]
    partial class ChainTxNetworkStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("xchwallet.ChainTxNetworkStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<long>("DateLastBroadcast");

                    b.Property<int>("Status");

                    b.Property<byte[]>("TxBin");
                    ...
                    b.ToTable("ChainTxNetworkStatus");
                });
            ...
            modelBuilder.Entity("xchwallet.ChainTxNetworkStatus", b =>
                {
                    b.HasOne("xchwallet.ChainTx", "Tx")
                        .WithOne("NetworkStatus")
                        .HasForeignKey("xchwallet.ChainTxNetworkStatus", "ChainTxId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
